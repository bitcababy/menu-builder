  ...
  context "cell rendering" do 
    ...
    context "rendering display" do
			...
			it "recursively renders each child of a child as a ul" do
				@menubar.children << ( Menu.make! text: 'Home', link: '#')
				m2 = Menu.make! text: 'Products', link: '#'
				@menubar.children << m2
				m2a = Menu.make! text: 'Product 1', link: '/products/1'
				m2.children << m2a
				m2b = Menu.make! text: 'Product 2', link: '/products/2'
				m2.children << m2b
				res = render_cell :menu_bar, :display, menu: @menubar
